...
int UHD_SAFE_MAIN(int argc, char *argv[]){
    ...
    //std::vector<std::complex<float> > buff1(usrp->get_device()->get_max_recv_samps_per_packet());
    int maxSamps = usrp->get_device()->get_max_recv_samps_per_packet();

    std::complex<short> buff[maxSamps];
    std::complex<short> buff1[maxSamps];
	...
	outfile.write("buf1", 4 * sizeof(char));
        outfile.write((const char*)&buff1[0], num_rx_samps * sizeof(std::complex<short>));
	outfile.write("buf2", 4 * sizeof(char));
